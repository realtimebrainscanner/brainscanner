function DLROC = calcDLROC(STrue,S,opts)
%==========================================================================
% Filename: calcDLROC.m (function).
% 
% Description:  Calculates the distance based localization receiver
%               operating characteristic (DL-ROC) curve.
%
